 ...
 *
 */
public class SummarizerMusicBrainz implements Summarizer {
	
	private static final String REPOSITORY = "https://wdaqua.univ-st-etienne.fr/hdt-endpoint/musicbrainz/sparql";
	...
	public static void main(String[] args) throws URISyntaxException {
		String uri = "http://musicbrainz.org/artist/f59c5520-5f46-4d2c-b2c4-822eabf53419#_";

		Summarizer summ = new SummarizerMusicBrainz();
